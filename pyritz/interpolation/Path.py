...
class Path():
    ...
    def action(self, alpha, grad=None):
    ...
    def __initialise_interpolation(self):
        self.Bs = Path.__get_barycentric_upsampling_matrix(self.collocation_ts, self.collocation_w, self.quadrature_ts, self.diff_matrices)
